...
// TOUCH 1 pin
#define TOUCH_SENSOR1_PIN 4

// TOUCH 2 pin
#define TOUCH_SENSOR2_PIN 12
...
bool button_pressed_state; // pressing the button toggles between states 1 + 2 + 3
...
void setup() {
  ...
  // 1st servo
  myservo1.attach(21);  // Attaches the servo on pin 4

  // 2nd servo
  myservo2.attach(22);  // Attaches the servo on pin 2
